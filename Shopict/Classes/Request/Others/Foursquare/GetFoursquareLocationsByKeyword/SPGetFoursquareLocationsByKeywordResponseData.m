//
//  SPGetFoursquareLocationsByKeywordResponseData.m
//  Shopict
//
...
@implementation SPGetFoursquareLocationsByKeywordResponseData
...
- (void)processResponseString
{
    ...
    if ([self isNormalResponse:data]) {
        ...
        NSArray *venues = [responseDictionary objectForKey:@"minivenues"];
