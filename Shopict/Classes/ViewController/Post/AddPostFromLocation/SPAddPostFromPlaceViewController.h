...
@class SPCategory,SPPost,SPVenue;
@protocol SPAddPostFromPlaceViewControllerDelegate <NSObject>

- (void)SPAddPostFromPlaceViewControllerDidUploadNewPost:(SPPost *)post;

@end

@interface SPAddPostFromPlaceViewController : SPBaseTabbedViewController
...
@property (retain, nonatomic) SPVenue *selectedVenue;
