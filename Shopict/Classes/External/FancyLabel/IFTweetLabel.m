...
- (void)createButtonWithText:(NSString *)text withFrame:(CGRect)frame
{
    ...
    UILabel *backGround = [[UILabel alloc]initWithFrame:CGRectMake(frame.origin.x+2, frame.origin.y, frame.size.width-6, frame.size.height)];
    [backGround setBackgroundColor:[UIColor whiteColor]];
    [self insertSubview:backGround aboveSubview:self.label];
    [backGround release];
